...
author: "Mark Webster"
date: |
  | Page last updated 2020-04-29
  | Data last updated 2020-03-29
---
...
one_year_ago <- as.Date("2019-03-29")
```
...
latest_play_dates <- rbind(matches[, .(last = max(end)), by = "player1"][, .(player = player1, last = last)],
                           matches[, .(last = max(end)), by = "player2"][, .(player = player2, last = last)]
