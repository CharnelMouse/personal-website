    ...
    `P1 win probability` = mapply(
      function(p1, p2, d1, d2) {
        ...
        deck_effects <- apply(
          vs_results$vs_array[
            ,
            as.character(codexdata::components(d1, starters, nicknames)),
            as.character(codexdata::components(d2, starters, nicknames))
          ],
          1,
          sum
        )
  ...
  current_score <- current_match_predictions[
    ...
    .(
      ...
      uncertainty = c(
        ...
        NA, # mean(`P1 win probability`)*(1 - mean(`P1 win probability`)),
        observed_overall_freq*(1 - observed_overall_freq)
      ),
      resolution = c(
        0,
