...
output:
  html_document:
    ...
    css: tables.css
author: "Mark Webster"
date: "2020-04-29, data last updated 2020-03-29"
---
...
This allows us to give the model's tier list for deck components with a simple measure: how much Nash weight does each component get?
...
Given the opponent's choice of deck, bit without knowing who will go first, how should we counter-pick?
