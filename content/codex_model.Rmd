...
```{r, "check ess"}
untidy_results <- readRDS("./codex_files/vs_split.rds")
...
results <- readRDS("./codex_files/tidy_vs_split.rds")
```
...
test_stoch_nash <- readRDS("./codex_files/nash_samples_vs_split.rds")
