...
Shrinking is partly where I want to avoid redundancy in the column value generator: if we don't then we can get situations where a column value is "shrunk" to something that's equivalent with respect to decomposition.
