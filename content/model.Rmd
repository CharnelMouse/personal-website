...
frameWidget(formatRound(datatable(model_log_scores, options = list(dom = "t"), rownames = FALSE), 2:3, 3), height = "100%")
```
...
frameWidget(formatRound(datatable(print_nash(greedy_mono_nash), options = list(dom = "t"), rownames = FALSE), 2, 3), 
height = "100%")
```

```{r, "greedy monocolour Nash details"}
frameWidget(DT_nash(greedy_mono_nash, round = 3, options = list(dom = "t")), 
            height = "100%")
```
...
frameWidget(formatRound(datatable(print_nash(calibrated_mono_nash), options = list(dom = "t"), rownames = FALSE), 2, 3), height = "100%")
```

```{r, "calibrated monocolour Nash details"}
frameWidget(DT_nash(calibrated_mono_nash, round = 3, options = list(dom = "t")), 
            height = "100%")
```
