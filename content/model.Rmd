...
formatRound(datatable(model_log_scores, rownames = FALSE, options = list(dom = "t")), 2:3, 2)
```
...
formatRound(datatable(vs_monos_print, rownames = FALSE, filter = "top"), c(3, 5), c(3, 2))
```
